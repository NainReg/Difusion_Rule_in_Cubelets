...
void loop() {
    ...
    uint8_t aux3 = get_block_value(1410404);
    uint8_t aux4 = get_block_value(1376339);
    uint8_t aux5 = get_block_value(935525);
    uint8_t aux6 = get_block_value(1376408);
    uint8_t aux7 = get_block_value(1460369);
