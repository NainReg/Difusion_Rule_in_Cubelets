...
void loop() {
    ...
    uint8_t aux4 = get_block_value(1410314);
    uint8_t aux5 = get_block_value(1460358);
    uint8_t aux6 = get_block_value(816343);
    uint8_t aux7 = get_block_value(1410451);
    uint8_t aux8 = get_block_value(1376424);
